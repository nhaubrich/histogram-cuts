...
void chainCut(){
	...
	TChain *GluGluHAAbbTauTau = new TChain("Events");
	...
	Float_t GenPart_pt;
  	GluGluHAAbbTauTau->SetBranchAddress("GenPart_pt",&GenPart_pt);		
	cout << "Set pt branch address" << endl;	
	Double_t nentries = GluGluHAAbbTauTau->GetEntries();
	cout << "Number of entries: " << nentries << endl;

	UInt_t nGenPart;
	GluGluHAAbbTauTau->SetBranchAddress("nGenPart",&nGenPart);
	cout << "Set nGenPart address" << endl;	

	//loop over entries	
	for(int j=0;j<9;j++){
		GluGluHAAbbTauTau->GetEntry(j);
		cout << GenPart_pt << endl;
		cout << nGenPart << endl;
